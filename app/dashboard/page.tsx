    ...
    try {
        ...
        return (
            <div className="min-h-screen bg-engine-black text-white flex flex-col items-center justify-center p-6 text-center">
                ...
                <h1 className="text-2xl font-display font-bold mb-2">System Malfunction</h1>
                <p className="text-gray-400 max-w-md mb-8">
                    The dashboard encountered a critical error while rendering.
                </p>
                <button
                    onClick={() => window.location.reload()}
                    className="px-6 py-2 bg-red-500/20 text-red-500 border border-red-500/50 rounded-lg font-bold hover:bg-red-500 hover:text-white transition-all"
                >
                    REBOOT SYSTEM
                </button>
            </div>
